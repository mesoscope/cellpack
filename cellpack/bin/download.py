...
#draft
def download(recipe_path, cred_path=r"/Users/Ruge/Desktop/Allen Internship/cellPACK/cellpack-data-582d6-firebase-adminsdk-3pkkz-27a3ec0777.json", db_id=DATABASE_IDS.FIREBASE):
    """
    ...
    if db_id==DATABASE_IDS.FIREBASE:
        ...
        #TODO-pass in data to download recipes
        ...
        recipe_db_handler.divide_recipe_into_collections(recipe_meta_data, recipe_full_data)
