# Ben Harling's python Octree v.1
...
class Octree:
    def __init__(self, center, worldSize):
        ...
        self.root = self.addNode(center, worldSize, [])
    ...
    def insertNode(self, root, size, parent, objData):
        ...
        elif root.position != objData.position and root.isLeafNode is False:
