...
class RotateScene(MacroNode):
    ...
    def afterAddingToNetwork(self):
        ...
        try:
            ...
            apply(
                Rotate_3.inputPortByName["matrices"].configure,
                (),
                {"color": "cyan", "cast": True, "shape": "rect"},
            )
            apply(
                Rotate_3.inputPortByName["vector"].configure,
                (),
                {
                    "datatype": "list",
                    "cast": True,
            ...
            apply(
                Rotate_3.inputPortByName["point"].configure,
                (),
                {"color": "white", "cast": True, "shape": "diamond"},
            )
            apply(
                Rotate_3.inputPortByName["angle"].configure,
                (),
        ...
        try:
            ...
            apply(
                One_Redraw_4.inputPortByName["viewer"].configure,
                (),
                {"color": "yellow", "cast": True, "shape": "rect"},
            )
            apply(
                One_Redraw_4.inputPortByName["trigger"].configure,
                (),
                {"color": "white", "cast": True, "shape": "diamond"},
            )
        except:
        ...
        try:
            ...
            Choose_Geom_5 = SelectGeometry(
                constrkw={}, name="Choose Geom", library=vizlib
            )
            self.macroNetwork.addNode(Choose_Geom_5, 412, 220)
            apply(
                Choose_Geom_5.inputPortByName["viewer"].configure,
                (),
                {"color": "yellow", "cast": True, "shape": "rect"},
            )
            apply(
                Choose_Geom_5.inputPortByName["geomName"].configure,
                (),
                {"color": "white", "cast": True, "shape": "oval"},
            )
            apply(
                Choose_Geom_5.outputPortByName["geometry"].configure,
                (),
                {"color": "red", "shape": "rect"},
            )
            apply(
                Choose_Geom_5.inputPortByName["geomName"].widget.configure,
                (),
                {"autoList": False, "choices": ("root",)},
            )
        ...
        try:
            ...
            apply(
                range_6.inputPortByName["fromInd"].configure,
                (),
                {"color": "yellow", "cast": True, "shape": "circle"},
            )
            apply(
                range_6.inputPortByName["toInd"].configure,
                (),
                {"color": "yellow", "cast": True, "shape": "circle"},
            )
            apply(
                range_6.inputPortByName["step"].configure,
                (),
                {"color": "yellow", "cast": True, "shape": "circle"},
            )
            apply(
                range_6.outputPortByName["data"].configure,
                (),
        ...
        try:
            ...
            apply(
                iterate_7.inputPortByName["listToLoopOver"].configure,
                (),
                {"color": "cyan", "cast": True, "shape": "oval"},
            )
            apply(
                iterate_7.outputPortByName["oneItem"].configure,
                (),
                {"color": "white", "shape": "diamond"},
            )
            apply(
                iterate_7.outputPortByName["iter"].configure,
                (),
                {"color": "yellow", "shape": "circle"},
            )
            apply(
                iterate_7.outputPortByName["begin"].configure,
                (),
                {"color": "yellow", "shape": "rect"},
            )
            apply(
                iterate_7.outputPortByName["end"].configure,
                (),
                {"color": "yellow", "shape": "rect"},
            )
            apply(
                iterate_7.outputPortByName["maxIter"].configure,
                (),
                {"color": "yellow", "shape": "circle"},
            )
        except:
        ...
        try:
            ...
            flattenRotation_8 = Generic(
                constrkw={}, name="flattenRotation", library=stdlib
            )
            self.macroNetwork.addNode(flattenRotation_8, 560, 200)
            apply(
                flattenRotation_8.addInputPort,
                (),
                {
                    "name": "in0",
                    "cast": True,
                    "datatype": "instancemat(0)",
                    "height": 8,
                    "width": 12,
                    "shape": "rect",
                    "color": "cyan",
            ...
            apply(
                flattenRotation_8.addOutputPort,
                (),
                {
                    "name": "out0",
                    "datatype": "float(16)",
...
"""
        ...
        try:
            ...
            apply(
                Pass_9.inputPortByName["in1"].configure,
                (),
                {"color": "white", "cast": True, "shape": "diamond"},
            )
            apply(
                Pass_9.outputPortByName["out1"].configure,
                (),
                {"color": "white", "shape": "diamond"},
            )
        ...
        try:
            ...
            apply(
                angle_10.inputPortByName["dial"].configure,
                (),
                {"color": "green", "cast": True, "shape": "circle"},
            )
            apply(
                angle_10.inputPortByName["mini"].configure,
                (),
                {"datatype": "int", "cast": True, "shape": "circle", "color": "yellow"},
            )
            apply(
                angle_10.inputPortByName["maxi"].configure,
                (),
                {"datatype": "int", "cast": True, "shape": "circle", "color": "yellow"},
            )
            apply(
                angle_10.outputPortByName["value"].configure,
                (),
                {"datatype": "int", "color": "yellow", "shape": "circle"},
            )
            apply(
                angle_10.inputPortByName["dial"].widget.configure,
                (),
                {"type": "int", "oneTurn": 100.0},
            )
        ...
        try:
            ...
            apply(
                nbSteps_11.inputPortByName["dial"].configure,
                (),
                {"color": "green", "cast": True, "shape": "circle"},
            )
            apply(
                nbSteps_11.inputPortByName["mini"].configure,
                (),
                {"color": "green", "cast": True, "shape": "circle"},
            )
            apply(
                nbSteps_11.inputPortByName["maxi"].configure,
                (),
                {"color": "green", "cast": True, "shape": "circle"},
            )
            apply(
                nbSteps_11.outputPortByName["value"].configure,
                (),
                {"color": "green", "shape": "circle"},
            )
            apply(
                nbSteps_11.inputPortByName["dial"].widget.configure,
                (),
                {"oneTurn": 10.0},
            )
        ...
        try:
            ...
            apply(
                select_axis_12.inputPortByName["x-axis"].configure,
                (),
                {"color": "yellow", "cast": True, "shape": "rect"},
            )
            apply(
                select_axis_12.inputPortByName["y-axis"].configure,
                (),
                {"color": "yellow", "cast": True, "shape": "rect"},
            )
            apply(
                select_axis_12.inputPortByName["z-axis"].configure,
                (),
                {"color": "yellow", "cast": True, "shape": "rect"},
            )
            apply(
                select_axis_12.outputPortByName["rotationAxis"].configure,
                (),
                {"color": "cyan", "shape": "oval"},
            )
        except:
        ...
        try:
            ...
            apply(
                call_method_13.inputPortByName["objects"].configure,
                (),
                {"datatype": "geom", "cast": True, "shape": "rect", "color": "red"},
            )
            apply(
                call_method_13.inputPortByName["signature"].configure,
                (),
                {"color": "white", "cast": True, "shape": "oval"},
            )
            apply(
                call_method_13.addInputPort,
                (),
                {
                    "name": "mat",
                    "cast": True,
            ...
            apply(
                call_method_13.outputPortByName["objects"].configure,
                (),
                {"color": "white", "shape": "diamond"},
            )
            apply(
                call_method_13.outputPortByName["results"].configure,
                (),
                {"color": "white", "shape": "diamond"},
            )
            call_method_13.inputPortByName["signature"].widget.set(
                "ConcatRotation %mat", run=False
            )
