...
def drawLegendLabelName(
    ...
    for v in lOnScreenLabelValues:
        ...
        lLabelsMinAndMax[-1] = (
            lLabelsMinAndMax[-1][0] * fontScale,
    ...
    if verticalLegend is True:
        if leftOrBelowLabels is False:
            ...
            lPt2 = (
                fontScale + lRoomToLegendCloseLongSide + lMaxWidth,
                -fontScale
                + lRoomToLegendCloseShortSide
                - lMaxLabelsHeight
                - lNameHeight,
            ...
            lPt3 = (
                fontScale + lRoomToLegendCloseLongSide + lMaxWidth,
                fontScale + lRoomToLegendFarShortSide + lMaxLabelsHeight + lUnitHeight,
                0,
            )
            lPt4 = (
                lRoomToLegendCloseLongSide,
            ...
            lPt1 = (
                -fontScale + lRoomToLegendFarLongSide - lMaxWidth,
                -fontScale
                + lRoomToLegendCloseShortSide
                - lMaxLabelsHeight
                - lNameHeight,
            ...
            lPt2 = (
                lRoomToLegendCloseLongSide + legendShortSide,
                -fontScale
                + lRoomToLegendCloseShortSide
                - lMaxLabelsHeight
                - lNameHeight,
        ...
        if leftOrBelowLabels is False:
            lPt1 = (
                -fontScale + lRoomToLegendCloseShortSide - lNameWidth,
                lRoomToLegendCloseLongSide,
                0,
            )
            lPt2 = (
                fontScale + lRoomToLegendFarShortSide + lUnitWidth,
                lRoomToLegendCloseLongSide,
                0,
            )
            lPt3 = (
    ...
    if tile is None:
        ...
        GL.glOrtho(
            float(tile[0]), float(tile[1]), float(tile[2]), float(tile[3]), -1, 1
        )
    ...
    if verticalLegend is True:
        if leftOrBelowLabels is True:
            ...
            lRoomBelowName = (
                -fontScaleHalf + roomBelowLegend - lMaxLabelsHeight - lNameHeight
            )
            lRoomBelowUnit = (
                fontScaleHalf + roomBelowLegend + legendLongSide + lMaxLabelsHeight
            )
        else:
        ...
        if leftOrBelowLabels is True:
            ...
            lRoomBelowLabel = (
                fontScaleHalf + lRoomToLegendCloseLongSide + legendShortSide
            )
            lRoomBelowName = (
                lRoomToLegendCloseLongSide
                + legendShortSideHalf
    ...
    GL.glPushMatrix()
    GL.glTranslatef(
        float(lRoomLeftToName + fontScale), float(lRoomBelowName - lNameMinAndMax[1]), 0
    )
    ...
    if selected is True:
        ...
        GL.glBegin(GL.GL_QUADS)
        GL.glVertex2f(
            float(resizeSpot[0] + resizeSpotRadius),
...
def drawLegendOnly(
    ...
    if len(ramp[0]) == 4:  # there are alpha values, draw checkered bg
        ...
        lCheckerSquareSize = legendShortSide * 0.5
