...
#########################################################################
#
# $Header: /opt/cvs/python/packages/share1.5/DejaVu/glfSticker.py,v 1.29 2008/11/20 00:54:16 vareille Exp $
#
# $Id: glfSticker.py,v 1.29 2008/11/20 00:54:16 vareille Exp $
#
...
class Sticker(Insert2d):
    ...
    framePolygonModeDict = {"none": GL.GL_NONE, "line": GL.GL_LINE, "fill": GL.GL_FILL}

    framePolygonModeDictRev = {
        GL.GL_NONE: "none",
        GL.GL_LINE: "line",
        GL.GL_FILL: "fill",
    }
    ...
    def calculateSize(self):
        ...
        lFramebounds = (
            lFramebounds[0] - self.frameSpace[0],
    ...
    def drawSticker(self, lLabelbounds):
        ...
        GL.glTranslatef(float(self.frameSpace[0]), float(self.frameSpace[1]), 0)
    ...
    def createOwnGui(self):
        ...
        self.ownGui.guiFramePolygonModeOptionMenu = Pmw.OptionMenu(
            ...
            items=list(self.framePolygonModeDict.keys()),
            command=self.setWithOwnGui,
        )
    ...
    def setWithOwnGui(self, event=None):
        ...
        self.Set(
            label=self.ownGui.labelEnt.get(),
            ...
            fontScales=(
                lGlobalScale * self.ownGui.guiFontScaleX.get(),
                lGlobalScale * self.ownGui.guiFontScaleY.get(),
            ),
            framePolygonMode=self.framePolygonModeDict[
                self.ownGui.guiFramePolygonModeOptionMenu.getcurselection()
            ],
            frameSpace=(
                self.ownGui.guiFrameSpaceX.get(),
    ...
    def updateOwnGui(self):
        ...
        self.ownGui.guiGlobalScale.set(1.0, update=0)
        self.ownGui.guiFontScaleX.set(self.fontScales[0], update=0)
        self.ownGui.guiFontScaleY.set(self.fontScales[1], update=0)
        self.ownGui.guiFramePolygonModeOptionMenu.selectitem(
            self.framePolygonModeDictRev[self.framePolygonMode]
        )
