...
class fromFileForm:
    ...
    def __init__(self, scenario, propnames, object, command=None):
        ...
        self.funcnameEF = Pmw.EntryField(
            frame,
            labelpos="n",
        ...
        b = self.createB = Tkinter.Button(
            frame, text="Create From File ...", command=self.getValues_cb
        )
