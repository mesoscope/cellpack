...
import importlib
import sys
spec = importlib.util.spec_from_file_location("oldnumeric", "/Applications/cellpack-blender/MGLToolsPckgs/numpy/oldnumeric/__init__.py")
...
"""
    ...
    def AddCamera(self, master=None, screenName=None, classCamera=None, stereo='none',
                  cnf={}, **kw):
