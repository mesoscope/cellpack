...
"""
    ...
    def test_geom_vertices_shape(self):
        """vertices and shape 
        """
        g = Geom(vertices=((0,0,0), (0,0,1),), shape=((0,0),))
        self.assertEqual(isinstance(g, Geom), True)
...
#vertices           
    def test_geom_vertices(self):
        ...
        self.assertEqual(True , numpy.alltrue(flat == self.geom.vertexSet.vertices.array.ravel()) )
...
#blendFunctions
    ...
    def test_geom_blend_func_one_minus_color(self):
        ...
        self.geom.Set(blendFunctions = (val1, val2))
        newstate=self.geom.getState()['blendFunctions']
        self.assertEqual(newstate,('GL_ONE_MINUS_DST_COLOR','GL.GL_ONE_MINUS_SRC_COLOR')) 
...
#translation
    def test_translation(self):
        ...
        self.assertEqual(numpy.alltrue(self.geom.getState()['translation']==numpy.ones(3)),True)
...
#scale
    def test_scale(self):
        ...
        self.assertEqual(numpy.alltrue(self.geom.getState()['scale']==Numeric.ones(3)*2),True)
...
#pivot
    def test_pivot(self):
        ...
        """
        self.geom.Set(pivot=numpy.ones(3)*.5)
        self.assertEqual(True, numpy.alltrue(self.geom.getState()['pivot']==numpy.ones(3)*.5))
...
#faces
    ...
    def test_IndexedGeom_faces_set(self):
        ...
        """
        self.geom.Set(vertices =[[0,0,0],[1,0,0]],faces=((0,1),(1,0),))
