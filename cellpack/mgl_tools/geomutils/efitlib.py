...
class ellipsoid(_object):
    ...
    def getPosition(self): return _efitlib.ellipsoid_getPosition(self)
    def getAxis(self): return _efitlib.ellipsoid_getAxis(self)
    def getOrientation(self): return _efitlib.ellipsoid_getOrientation(self)
    def __init__(self): 
