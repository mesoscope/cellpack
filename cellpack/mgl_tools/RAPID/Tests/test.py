...
class RapidTests(unittest.TestCase):
    ...
    def test_Collide(self):
        ...
        if self.vi:
            ...
            obj1 = IndexedPolygons("obj1", vertices = p, faces = trs_arr,
                                   inheritMaterial = 0)
            col2 = Numeric.array(((0,1,0,1),), 'f')
            obj2 = IndexedPolygons("obj2", vertices = p, faces = trs_arr,
                                   inheritMaterial = 0, materials = col2)
        ...
        RAPIDlib.RAPID_Collide_scaled(R1, T1,1.0, b1, R2, T2, 1.0,b2, RAPIDlib.cvar.RAPID_ALL_CONTACTS)
        ...
        RAPIDlib.RAPID_Collide_scaled(R1, T1, 1.0,b1, R2, T2, 1.0,b2,RAPIDlib.cvar.RAPID_FIRST_CONTACT);
