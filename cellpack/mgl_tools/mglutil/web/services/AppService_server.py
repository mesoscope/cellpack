...
# Messages
getAppMetadataRequest = GED(
    "http://nbcr.sdsc.edu/opal/types", "getAppMetadataInput"
).pyclass

getAppMetadataResponse = GED(
    "http://nbcr.sdsc.edu/opal/types", "getAppMetadataOutput"
).pyclass

getAppConfigRequest = GED(
    "http://nbcr.sdsc.edu/opal/types", "getAppConfigInput"
).pyclass

getAppConfigResponse = GED(
    "http://nbcr.sdsc.edu/opal/types", "getAppConfigOutput"
).pyclass
...
launchJobBlockingRequest = GED(
    "http://nbcr.sdsc.edu/opal/types", "launchJobBlockingInput"
).pyclass

launchJobBlockingResponse = GED(
    "http://nbcr.sdsc.edu/opal/types", "launchJobBlockingOutput"
).pyclass

queryStatusRequest = GED("http://nbcr.sdsc.edu/opal/types", "queryStatusInput").pyclass

queryStatusResponse = GED(
    "http://nbcr.sdsc.edu/opal/types", "queryStatusOutput"
).pyclass
...
getOutputAsBase64ByNameRequest = GED(
    "http://nbcr.sdsc.edu/opal/types", "getOutputAsBase64ByNameInput"
).pyclass

getOutputAsBase64ByNameResponse = GED(
    "http://nbcr.sdsc.edu/opal/types", "getOutputAsBase64ByNameOutput"
).pyclass
...
class AppService(ServiceSOAPBinding):
    ...
    root[
        (getAppMetadataRequest.typecode.nspname, getAppMetadataRequest.typecode.pname)
    ] = "soap_getAppMetadata"
    ...
    root[
        (getAppConfigRequest.typecode.nspname, getAppConfigRequest.typecode.pname)
    ] = "soap_getAppConfig"
    ...
    root[
        (launchJobRequest.typecode.nspname, launchJobRequest.typecode.pname)
    ] = "soap_launchJob"
    ...
    root[
        (
            launchJobBlockingRequest.typecode.nspname,
            launchJobBlockingRequest.typecode.pname,
        )
    ] = "soap_launchJobBlocking"
    ...
    root[
        (queryStatusRequest.typecode.nspname, queryStatusRequest.typecode.pname)
    ] = "soap_queryStatus"
    ...
    root[
        (getOutputsRequest.typecode.nspname, getOutputsRequest.typecode.pname)
    ] = "soap_getOutputs"
    ...
    soapAction[
        "http://nbcr.sdsc.edu/opal/getOutputAsBase64ByName"
    ] = "soap_getOutputAsBase64ByName"
    root[
        (
            getOutputAsBase64ByNameRequest.typecode.nspname,
            getOutputAsBase64ByNameRequest.typecode.pname,
        )
    ] = "soap_getOutputAsBase64ByName"
    ...
    root[
        (destroyRequest.typecode.nspname, destroyRequest.typecode.pname)
    ] = "soap_destroy"
