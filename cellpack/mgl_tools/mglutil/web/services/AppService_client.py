...
class AppServiceLocator:
    ...
    def getAppServicePort(self, url=None, **kw):
        return AppServicePortTypeSoapBindingSOAP(
            url or AppServiceLocator.AppServicePort_address, **kw
        )
...
class AppServicePortTypeSoapBindingSOAP:
    ...
    def getJobStatistics(self, request, **kw):
        ...
        self.binding.Send(
            ...
            None,
            request,
            soapaction="http://nbcr.sdsc.edu/opal/getJobStatistics",
            **kw
        )
        # no output wsaction
...
getJobStatisticsRequest = GED(
    "http://nbcr.sdsc.edu/opal/types", "getJobStatisticsInput"
).pyclass

getJobStatisticsResponse = GED(
    "http://nbcr.sdsc.edu/opal/types", "getJobStatisticsOutput"
).pyclass
