...
class SecuritymyproxyloginImplServiceLocator(SecuritymyproxyloginImplServiceInterface):
    SecuritymyproxyloginImpl_address = (
        "https://gama.nbcr.net:9443/axis/services/SecurityMyproxyloginService"
    )
    ...
    def getSecuritymyproxyloginImpl(self, portAddress=None, **kw):
        return SecurityMyproxyloginServiceSoapBindingSOAP(
            portAddress
            or SecuritymyproxyloginImplServiceLocator.SecuritymyproxyloginImpl_address,
            **kw
        )
...
class SecurityMyproxyloginServiceSoapBindingSOAP:
    ...
    def loginUserMyProxy(self, request):
        ...
        if not isinstance(request, loginUserMyProxyRequest) and not issubclass(
            loginUserMyProxyRequest, request.__class__
        ):
        ...
        if not isinstance(response, loginUserMyProxyResponse) and not issubclass(
            loginUserMyProxyResponse, response.__class__
        ):
    ...
    def __init__(self, name=None, ns=None):
        ...
        if name:
            ...
            ZSI.TC.Struct.__init__(
                self,
                loginUserMyProxyRequest,
                [
                    ZSI.TC.String(pname="username", aname="_username", optional=1),
                    ZSI.TC.String(pname="passwd", aname="_passwd", optional=1),
                ],
                pname=name,
                aname="%s" % name,
                oname=oname,
...
class loginUserMyProxyResponse(ZSI.TCcompound.Struct):
    def __init__(self, name=None, ns=None):
        ...
        if name:
            ...
            ZSI.TC.Struct.__init__(
                self,
                loginUserMyProxyResponse,
                [
                    ZSI.TC.String(
                        pname="loginUserMyProxyReturn",
                        aname="_loginUserMyProxyReturn",
                        optional=1,
                    ),
                ],
                pname=name,
...
class loginUserMyProxyResponseWrapper(loginUserMyProxyResponse):
    ...
    def __init__(self, name=None, ns=None, **kw):
        loginUserMyProxyResponse.__init__(
            self, name="loginUserMyProxyResponse", ns="urn:axis"
        )
