...
class RigidfitBodyAligner:
    ...
    def rigidFit(self, mobileCoords):
        ...
        for i in range(3):
            trans3[i] = (
                mobileCentroid[0] * rot[0][i]
                + mobileCentroid[1] * rot[1][i]
        ...
        # vvdiff(cx,cy,trans);
        trans = (
            refCentroid[0] - trans3[0],
            refCentroid[1] - trans3[1],
...
if __name__ == "__main__":
    ...
    a = [[0.0, 0.0, 0.0], [10.0, 0.0, 0.0], [0.0, 10.0, 0.0], [0.0, 0.0, 10.0]]

    b = [[0.0, 0.0, 0.0], [10.0, 0.0, 0.0], [0.0, 0.0, -10.0], [0.0, 10.0, 0.0]]
