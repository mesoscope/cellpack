...
class ToolBarButton(tkinter.Label):
    ...
    def __init__(
        ...
        tkinter.Label.__init__(
            self, master, height=height, width=width, relief="flat", bd=bd, bg=bg
        )
...
if __name__ == "__main__":
    ...
    # add separator icon
    ToolBarButton(
        tbframe, tbframe, name="sep1", icon1="sep.gif", width=10, state="disabled"
    )
    # add 5 smilies
    ...
    # add separator icon
    ToolBarButton(
        tbframe, tbframe, name="sep2", icon1="sep.gif", width=10, state="disabled"
    )
