...
########################################################################
#
# $Header: /opt/cvs/python/packages/share1.5/mglutil/gui/BasicWidgets/Tk/trees/tree.py,v 1.40 2010/11/10 03:57:29 sanner Exp $
#
# $Id: tree.py,v 1.40 2010/11/10 03:57:29 sanner Exp $
#
...
"""
    ...
    def yview(self, *args):
        ...
        if args[0] == "scroll":
            ...
            if self.firstVisibleNodeLineNum != line:
                self.scrollView(line - self.firstVisibleNodeLineNum)
    ...
    def scrollView(self, deltalines):
        ...
        if deltalines > 0:
            ...
            deltalines = min(last-self.firstVisibleNodeLineNum, deltalines)
