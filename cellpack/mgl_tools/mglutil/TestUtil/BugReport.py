...
##
##$Id: BugReport.py,v 1.16 2010/09/02 22:23:33 sargis Exp $
...
class BugReportCommand:
    ...
    def showuploadpage_cb(
        ...
        from mglutil.util.packageFilePath import (
            findFilePath,
        ...
        params = urllib.urlencode(
            {
                "Bugzilla_login": "anonymous_bugzilla@yahoo.com",
                "Bugzilla_password": "mgltools",
                "version": version,
                "rep_platform": "All",
                "priority": "P2",
                "op_sys": "All",
        ...
        if len(atcont) > 0:
            ...
            for f in filelist:
                if len(f) >= 1:
                    ...
                    req = urllib2.Request(
                        "http://mgldev.scripps.edu/bugs/attachment.cgi", params1
                    )
