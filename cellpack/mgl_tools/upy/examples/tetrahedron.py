...
class Tetrahedron(uiadaptor):
    ...
    def initWidget(self, id=None):
        ...
        self.PUSHS = {}
        self.PUSHS["Tetrahedron"] = self._addElemt(
            id=id,
            name="Tetrahedron",
            width=80,
            height=10,
            action=self.createTetrahedron,
            type="button",
            icon=None,
        ...
        self.SLIDERS = {
            "Tetrahedron": self._addElemt(
                id=id,
                name="Tetrahedron_scale",
                width=80,
                height=10,
                action=self.scaleTetrahedron,
                type="sliders",
    ...
    def setupLayout(self):
        ...
        frame1 = self._addLayout(
            id=100, name="Tetrahedron", elems=elemFrame1, type="tab"
        )
