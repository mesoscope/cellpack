...
if MAYA:
    sys.path.append(
        "/Users/ludo/Library/Preferences/Autodesk/maya/2015-x64/plug-ins/MGLToolsPckgs"
    )
    sys.path.append(
        "/Users/ludo/Library/Preferences/Autodesk/maya/2015-x64/plug-ins/MGLToolsPckgs/PIL"
    )
...
if MAYA:
    helper.read(
        "/Users/ludo/DEV/autopack_git/autoPACK_database_1.0.0/geometries/HIV1_capsid_3j3q_Rep_Maker_0_1_0.fbx"
    )
...
def instancesToCollada(self, parent_object, collada_xml=None, instance_node=True, **kw):
    ...
    if "mesh" in kw and kw["mesh"] is not None:
        ...
        f, v, vn = self.DecomposeMesh(
            kw["mesh"], edit=False, copy=False, tri=True, transform=False
        )
    else:
        ...
        f, v, vn = self.DecomposeMesh(
            inst_master, edit=False, copy=False, tri=True, transform=False
        )
...
collada_xml = instancesToCollada(
    helper,
    parent_object,
    collada_xml=None,
    instance_node=True,
...
collada_xml.write(
    "/Users/ludo/DEV/cellPACK_data/cellPACK_database_1.1.0/geometries/HIV1_capside_3j3q_Rep_Med_0_2_1.dae"
)
