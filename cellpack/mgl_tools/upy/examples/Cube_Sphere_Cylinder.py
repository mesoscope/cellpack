...
class SphereCubeCylUI(uiadaptor):
    ...
    def initWidget(self, id=None):
        ...
        self.PUSHS["CreateSphere"] = self._addElemt(
            name="Sphere",
            width=80,
            height=10,
            action=self.createSphere,
            type="button",
            icon=None,
        ...
        self.PUSHS["CreateCube"] = self._addElemt(
            name="Cube",
            width=80,
            height=10,
            action=self.createCube,
            type="button",
            icon=None,
            variable=self.addVariable("int", 0),
            label="create Cube",
        ...
        # then  add a button that will trigger the creation of the cube
        self.PUSHS["CreateCone"] = self._addElemt(
            name="Cone",
            width=80,
            height=10,
            action=self.createCone,
            type="button",
            icon=None,
            variable=self.addVariable("int", 0),
            label="create Cone",
        ...
        self.SLIDERS = {
            "sphere": self._addElemt(
                name="sphere_scale",
                width=80,
                height=10,
                action=self.scaleSphere,
                type="sliders",
            ...
            "coneH": self._addElemt(
                name="cone_height",
                width=80,
                height=10,
                action=self.scaleCone,
                type="sliders",
                variable=self.addVariable("float", 1.0),
                mini=0.0,
                maxi=10.0,
        ...
        self.synchro = self._addElemt(
            name="synchroPos",
            width=80,
            height=10,
            action=self.setSynchro,
            type="checkbox",
            variable=self.addVariable("int", 0),
            label="synchro position",
        )
        self.userDialogPercentage = self._addElemt(
            name="scaleTrans",
            width=80,
            height=10,
            action=None,
        ...
        self.selectedObject = self._addElemt(
            name="selObj",
            width=80,
            height=10,
            action=None,
        ...
        self.translateObjX = self._addElemt(
            name="selObjX",
            width=80,
            height=10,
            action=self.translateSel,
            type="inputFloat",
        ...
        self.labelSel = self._addElemt(
            label="Move X-position of :", width=80, height=10
        )
    ...
    def setupLayout(self, ftype="frame"):
        ...
        frame1 = self._addLayout(
            name="Sphere", elems=elemFrame1, type=ftype, collapse=False
        )
        ...
        frame2 = self._addLayout(
            name="Cube", elems=elemFrame2, type=ftype, collapse=False
        )
        ...
        frame3 = self._addLayout(
            name="Cone", elems=elemFrame3, type=ftype, collapse=False
        )
        ...
        frame4 = self._addLayout(
            name="selection Object", elems=elemFrame4, type=ftype, collapse=False
        )
