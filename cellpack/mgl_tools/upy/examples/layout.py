...
class LayoutUI(uiadaptor):
    ...
    def initWidget(self, id=None):
        ...
        #    self.setupMenu()
        self.CHECKBOXS = {
            "checkbox1": self._addElemt(
                name="checkbox1",
                width=80,
                height=10,
                action=self.checkbox1_cb,
                type="checkbox",
                icon=None,
                variable=self.addVariable("int", 0),
            ),
            "checkbox2": self._addElemt(
                name="checkbox2",
                width=80,
                height=10,
                action=self.checkbox2_cb,
                type="checkbox",
                icon=None,
                variable=self.addVariable("int", 0),
            ),
            "checkbox3": self._addElemt(
                name="checkbox3",
                width=80,
                height=10,
                action=self.checkbox3_cb,
                type="checkbox",
                icon=None,
                variable=self.addVariable("int", 0),
            ),
        ...
        self.BTN = {
            "button1": self._addElemt(
                name="button1",
                width=80,
                height=10,
                action=self.button1_cb,
                type="button",
                icon=None,
            ),
            "button2": self._addElemt(
                name="button2",
                width=80,
                height=10,
                action=self.button2_cb,
                type="button",
                icon=None,
            ),
            "close": self._addElemt(
                name="close",
                width=80,
                height=10,
                action=self._close,
        ...
        self.INPUT = {
            "string": self._addElemt(
                name="string input",
                action=self.input_string_cb,
                width=50,
            ...
            "float": self._addElemt(
                name="float input",
                action=self.input_float_cb,
                width=50,
                value=0.0,
                type="inputFloat",
                mini=0.0,
        ...
        self.area = self._addElemt(
            ...
            value=txt,
            type="inputStrArea",
            variable=self.addVariable("str", txt),
            height=100,
        )

        self.SLIDERS = {
            "slider1": self._addElemt(
                name="slider1",
                width=80,
                height=10,
                action=self.slider1_cb,
                type="slidersInt",
                label="slider 1",
            ...
            "slider2": self._addElemt(
                name="slider2",
                width=80,
                height=10,
                action=self.slider2_cb,
                type="sliders",
                label="slider 2",
        ...
        self.COLFIELD = self._addElemt(
            id=id,
            name="chooseCol",
            action=self.color_cb,
            variable=self.addVariable("col", (0.0, 0.0, 0.0)),
            type="color",
            width=30,
            height=15,
        )
        ...
        self.COMB_BOX = {
            "menu1": self._addElemt(
                name="Liste1",
                value=["None"],
                width=60,
                height=10,
                action=self.liste1_cb,
                variable=self._vliste1,
                type="pullMenu",
            ),  # self.setCurMol
            "menu2": self._addElemt(
                name="Liste2",
                value=self.vliste2,
                width=80,
                height=10,
                action=self.liste2_cb,
    ...
    def setupLayout(self):
        ...
        elemFrame1.append(
            [
                self.CHECKBOXS["checkbox1"],
                self.CHECKBOXS["checkbox2"],
                self.CHECKBOXS["checkbox3"],
            ]
        )
        frame1 = self._addLayout(
            id=100, name="CheckBox", elems=elemFrame1, type=typeLayout
        )
        ...
        frame1 = self._addLayout(
            id=110, name="Buttons", elems=elemFrame1, type=typeLayout
        )
        self._layout.append(frame1)
        ...
        frame1 = self._addLayout(
            id=120, name="Inputs", elems=elemFrame1, type=typeLayout
        )
        self._layout.append(frame1)
        ...
        frame1 = self._addLayout(
            id=130, name="TextArea", elems=elemFrame1, type=typeLayout
        )
        self._layout.append(frame1)
        ...
        frame1 = self._addLayout(
            id=140, name="Sliders", elems=elemFrame1, type=typeLayout
        )
        self._layout.append(frame1)
        ...
        frame1 = self._addLayout(
            id=150, name="Color", elems=elemFrame1, type=typeLayout
        )
        self._layout.append(frame1)
        ...
        frame1 = self._addLayout(
            id=160, name="PullDown Menu", elems=elemFrame1, type=typeLayout
        )
        self._layout.append(frame1)
