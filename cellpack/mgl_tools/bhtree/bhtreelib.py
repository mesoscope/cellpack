...
def findFaceSubset(*args) -> "int *" :
  return _bhtreelib.findFaceSubset(*args)
...
class BHtree(_object):
    ...
    def closePoints(self, *args) -> "int" : return _bhtreelib.BHtree_closePoints(self, *args)
    def closePointsDist(self, *args) -> "int" : return _bhtreelib.BHtree_closePointsDist(self, *args)
    def closePointsDist2(self, *args) -> "int" : return _bhtreelib.BHtree_closePointsDist2(self, *args)
    def closePointsPairsInTree(self, *args) -> "int *" : return _bhtreelib.BHtree_closePointsPairsInTree(self, *args)
    def closePointsPairs(self, *args) -> "int *" : return _bhtreelib.BHtree_closePointsPairs(self, *args)
    def closestPointsArray(self, *args) -> "int *" : return _bhtreelib.BHtree_closestPointsArray(self, *args)
    def closestPointsArrayDist2(self, *args) -> "int *" : return _bhtreelib.BHtree_closestPointsArrayDist2(self, *args)
BHtree_swigregister = _bhtreelib.BHtree_swigregister
BHtree_swigregister(BHtree)


def generateBHtree(*args) -> "BHtree *" :
  return _bhtreelib.generateBHtree(*args)
generateBHtree = _bhtreelib.generateBHtree

def findBHnode(*args) -> "BHnode *" :
  return _bhtreelib.findBHnode(*args)
findBHnode = _bhtreelib.findBHnode

def findBHcloseAtoms(*args) -> "int" :
  return _bhtreelib.findBHcloseAtoms(*args)
findBHcloseAtoms = _bhtreelib.findBHcloseAtoms

def findBHcloseAtomsdist(*args) -> "int" :
  return _bhtreelib.findBHcloseAtomsdist(*args)
findBHcloseAtomsdist = _bhtreelib.findBHcloseAtomsdist

def findBHcloseAtomsdist2(*args) -> "int" :
  return _bhtreelib.findBHcloseAtomsdist2(*args)
findBHcloseAtomsdist2 = _bhtreelib.findBHcloseAtomsdist2

def freeBHtree(*args) -> "void" :
  return _bhtreelib.freeBHtree(*args)
freeBHtree = _bhtreelib.freeBHtree

def divideBHnode(*args) -> "void" :
  return _bhtreelib.divideBHnode(*args)
divideBHnode = _bhtreelib.divideBHnode

def freeBHnode(*args) -> "void" :
  return _bhtreelib.freeBHnode(*args)
freeBHnode = _bhtreelib.freeBHnode

def findClosePairsInTree(*args) -> "int *" :
  return _bhtreelib.findClosePairsInTree(*args)
findClosePairsInTree = _bhtreelib.findClosePairsInTree

def findClosePairs(*args) -> "int *" :
  return _bhtreelib.findClosePairs(*args)
findClosePairs = _bhtreelib.findClosePairs

def findClosestAtoms(*args) -> "int *" :
  return _bhtreelib.findClosestAtoms(*args)
findClosestAtoms = _bhtreelib.findClosestAtoms

def findClosestAtomsDist2(*args) -> "float *" :
  return _bhtreelib.findClosestAtomsDist2(*args)
...
class TBHTree(_object):
    ...
    __del__ = lambda self : None;
    def ClosePoints(self, *args) -> "int" : return _bhtreelib.TBHTree_ClosePoints(self, *args)
    def ClosePointsDist2(self, *args) -> "int" : return _bhtreelib.TBHTree_ClosePointsDist2(self, *args)
...
class RBHTree(_object):
    ...
    __del__ = lambda self : None;
    def ClosePoints(self, *args) -> "int" : return _bhtreelib.RBHTree_ClosePoints(self, *args)
    def ClosePointsDist2(self, *args) -> "int" : return _bhtreelib.RBHTree_ClosePointsDist2(self, *args)
    def InsertRBHPoint(self, *args) -> "int" : return _bhtreelib.RBHTree_InsertRBHPoint(self, *args)
    def DeleteRBHPoint(self, *args) -> "int" : return _bhtreelib.RBHTree_DeleteRBHPoint(self, *args)
    def MoveRBHPoint(self, *args) -> "int" : return _bhtreelib.RBHTree_MoveRBHPoint(self, *args)
RBHTree_swigregister = _bhtreelib.RBHTree_swigregister
RBHTree_swigregister(RBHTree)


def GenerateTBHTree(*args) -> "TBHTree *" :
  return _bhtreelib.GenerateTBHTree(*args)
GenerateTBHTree = _bhtreelib.GenerateTBHTree

def FindTBHNodeUp(*args) -> "TBHNode *" :
  return _bhtreelib.FindTBHNodeUp(*args)
FindTBHNodeUp = _bhtreelib.FindTBHNodeUp

def FindTBHNode(*args) -> "TBHNode *" :
  return _bhtreelib.FindTBHNode(*args)
FindTBHNode = _bhtreelib.FindTBHNode

def FreeTBHTree(*args) -> "void" :
  return _bhtreelib.FreeTBHTree(*args)
FreeTBHTree = _bhtreelib.FreeTBHTree

def FreeTBHNode(*args) -> "void" :
  return _bhtreelib.FreeTBHNode(*args)
FreeTBHNode = _bhtreelib.FreeTBHNode

def MoveTBHPoint(*args) -> "int" :
  return _bhtreelib.MoveTBHPoint(*args)
MoveTBHPoint = _bhtreelib.MoveTBHPoint

def DivideTBHNode(*args) -> "void" :
  return _bhtreelib.DivideTBHNode(*args)
DivideTBHNode = _bhtreelib.DivideTBHNode

def FindTBHCloseAtomsDist(*args) -> "int" :
  return _bhtreelib.FindTBHCloseAtomsDist(*args)
FindTBHCloseAtomsDist = _bhtreelib.FindTBHCloseAtomsDist

def FindTBHCloseAtomsInNodeDist(*args) -> "int" :
  return _bhtreelib.FindTBHCloseAtomsInNodeDist(*args)
FindTBHCloseAtomsInNodeDist = _bhtreelib.FindTBHCloseAtomsInNodeDist

def FindTBHCloseAtoms(*args) -> "int" :
  return _bhtreelib.FindTBHCloseAtoms(*args)
FindTBHCloseAtoms = _bhtreelib.FindTBHCloseAtoms

def FindTBHCloseAtomsInNode(*args) -> "int" :
  return _bhtreelib.FindTBHCloseAtomsInNode(*args)
FindTBHCloseAtomsInNode = _bhtreelib.FindTBHCloseAtomsInNode

def ModifyBHPoint(*args) -> "int" :
  return _bhtreelib.ModifyBHPoint(*args)
ModifyBHPoint = _bhtreelib.ModifyBHPoint

def GenerateRBHTree(*args) -> "RBHTree *" :
  return _bhtreelib.GenerateRBHTree(*args)
GenerateRBHTree = _bhtreelib.GenerateRBHTree

def FindRBHNode(*args) -> "TBHNode *" :
  return _bhtreelib.FindRBHNode(*args)
FindRBHNode = _bhtreelib.FindRBHNode

def FreeRBHTree(*args) -> "void" :
  return _bhtreelib.FreeRBHTree(*args)
FreeRBHTree = _bhtreelib.FreeRBHTree

def InsertRBHPoint(*args) -> "int" :
  return _bhtreelib.InsertRBHPoint(*args)
InsertRBHPoint = _bhtreelib.InsertRBHPoint

def DeleteRBHPoint(*args) -> "int" :
  return _bhtreelib.DeleteRBHPoint(*args)
DeleteRBHPoint = _bhtreelib.DeleteRBHPoint

def MoveRBHPoint(*args) -> "int" :
  return _bhtreelib.MoveRBHPoint(*args)
MoveRBHPoint = _bhtreelib.MoveRBHPoint

def ModifyRBHPoint(*args) -> "int" :
  return _bhtreelib.ModifyRBHPoint(*args)
ModifyRBHPoint = _bhtreelib.ModifyRBHPoint

def FindRBHCloseAtomsDist(*args) -> "int" :
  return _bhtreelib.FindRBHCloseAtomsDist(*args)
FindRBHCloseAtomsDist = _bhtreelib.FindRBHCloseAtomsDist

def FindRBHCloseAtoms(*args) -> "int" :
  return _bhtreelib.FindRBHCloseAtoms(*args)
