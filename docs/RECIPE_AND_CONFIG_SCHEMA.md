...
| `format_version` | string | Schema format version | No? | `[[ 0, 0, 0 ], [ 20, 20, 20 ]]` |  |
...
| `image_export_options.projection_axis` | string | Image projection axis | `z` | e.g., `x`, `y`, `z` |
| `image_export_options.voxel_size` | array `[x, y, z]` | Voxel size for image export | | `[1, 1, 1]` | RetryClaude can make mistakes. Please double-check responses. |
